...
public class sudoku{
    ...
    public static void echangeLignes(int[][] tab, int ligne1, int ligne2){
        int taille = tab[ligne1].length;
    ...
    public static void echangeColonnes(int[][] tab, int colonne1, int colonne2){
        int taille = tab.length;
        int[] temp = new int[taille];
        for(int i=0; i<taille; i++){
            temp[i] = tab[i][colonne1];
        }
        for(int i=0; i<taille; i++){
            tab[i][colonne1] = tab[i][colonne2];
            tab[i][colonne2] = temp[i];
        }
    }

    public static void echangeLignesAleatoire(int[][] tab){
        int i = randRange(0, 3);
        int j = randRange(0, 3);
        int k = randRange(0, 3);
        int ligne1 = i+3*j;
        int ligne2 = k+3*j;
        echangeLignes(tab, ligne1, ligne2);
    }

    public static void echangeColonnesAleatoire(int[][] tab){
        int i = randRange(0, 3);
        int j = randRange(0, 3);
        int k = randRange(0, 3);
        int colonne1 = i+3*j;
        int colonne2 = k+3*j;
        echangeColonnes(tab, colonne1, colonne2);
    }
    ...
    public static void main(String[] args){
        int[][] verif = grilleSimple();
        afficheGrille(verif);
        System.out.println();
        int[][] t = produitGrille(100, 70);
        afficheGrille(t);
        System.out.println();
